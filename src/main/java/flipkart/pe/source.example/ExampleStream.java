...
package flipkart.pe.source.example;
...
public class ExampleStream extends AbstractAdapterIncludedStream {
  ...
  public SpDataStream declareModel() {
    return DataStreamBuilder.create("flipkart.pe.source.example")
          ...
          .protocol(Protocols.kafka(Config.INSTANCE.getKafkaHost(), Config.INSTANCE.getKafkaPort(), "flipkart.source.jvm"))
          .build();
  }
