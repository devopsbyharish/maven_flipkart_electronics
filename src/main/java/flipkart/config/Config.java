...
public enum Config implements PeConfig {
  ...
  private final static String SERVICE_ID = "pe/flipkart.source";

  Config() {
    config = SpConfig.getSpConfig(SERVICE_ID);
    config.register(ConfigKeys.HOST, "electronics", "Data source host");
    config.register(ConfigKeys.PORT, 8090, "Data source port");
    config.register(ConfigKeys.SERVICE_NAME, "electronics", "Data source service name");
